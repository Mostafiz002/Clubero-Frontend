        ...
        <div>
          <div className="relative inline-block mt-6">
            <h2 className="heading">
              Club <span className="text-accent">Settings</span>
            </h2>
            <motion.span
          ...
          <p className="text-slate-500 mt-1">
            Create and oversee your club communities.
          </p>
        </div>
        <motion.button
      ...
      <motion.div variants={itemVars}>
        {clubs.length > 0 ? (
          ...
          >
            ...
            <p className="text-slate-500 mb-6">Start your community today.</p>
          </motion.div>
        )}
      </motion.div>
      {/*  Modal */}
        ...
        <dialog className="modal modal-open">
          <div className="modal-box max-w-xl">
            ...
            >
              ...
              <div>
                <label className="label">
                  <span className="label-text font-medium">Membership Fee</span>
                </label>
                <input
                  type="number"
...
export default ManageClubsManager;
