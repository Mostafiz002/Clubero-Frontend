...
import EventCardManager from "../../../components/dashboard/EventCardManager";
...
const EventManagement = () => {
  ...
  const handleCreateEvent = (data) => {
    if (role !== "club-manager") {
      return toast.error("Only club manager can create event");
    }
    ...
    <div>
      ...
      >
        <div>
          ...
          <p className="text-slate-500 mt-1">Create and oversee your event.</p>
        </div>
        <motion.button
            ...
            >
              ...
              >
                ...
                <div className="modal-action">
                  ...
                  <button
                    type="submit"
                    className="bg-green-500 cursor-pointer text-white px-4 py-2 rounded-md hover:bg-green-600 transition-colors"
                  >
                    Create Event
                  </button>
                </div>
